 ...
 * }
 */
public class InfoItemObject extends APIObject implements Serializable {
    static final String TAG = InfoItemObject.class.getName();
    private String eventDate;
    private String logType;
    private String logSubtype;
    private String message;

    public InfoItemObject(JSONObject json) {
        super(json);
        try {
            parse(json);
